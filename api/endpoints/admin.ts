...
export const adminEndpoints = {
  ...
  orders: {
    ...
    updateStatus: (id: Id) => `/api/admin/orders/status/${id}`,
    updatePaymentStatus: (id: Id) => `/api/admin/orders/payment-status/${id}`,
    updateShippingStatus: (id: Id) => `/api/admin/orders/shipping-status/${id}`,
    addItem: (id: Id) => `/api/admin/orders/${id}/items`,
    updateItem: (orderId: Id, itemId: Id) => `/api/admin/orders/${orderId}/items/${itemId}`,
    deleteItem: (orderId: Id, itemId: Id) => `/api/admin/orders/${orderId}/items/${itemId}`,
    recalculate: (id: Id) => `/api/admin/orders/${id}/recalculate`,
    confirm: (id: Id) => `/api/admin/orders/${id}/confirm`,
    cancel: (id: Id) => `/api/admin/orders/${id}/cancel`,
    bulkUpdateStatus: '/api/admin/orders/bulk-update-status',
  },
  warehouses: {
