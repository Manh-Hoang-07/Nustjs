          ...
          <nav class="flex items-center space-x-4">
            ...
            <ClientOnly>
              ...
              <template v-else>
                ...
                <NuxtLink to="/auth/register" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                  Đăng ký
                </NuxtLink>
              </template>
