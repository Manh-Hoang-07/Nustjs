<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-6">
    <div class="flex justify-between items-center mb-6">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">Test Posts</h1>
        <p class="text-gray-600 mt-2">Test page để kiểm tra useCrudAdmin</p>
      </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow">
      ...
      <div class="space-y-4">
        ...
        <div>
          <strong>CRUD Admin Object:</strong> {{ crudAdmin ? 'Exists' : 'Null' }}
        </div>
      </div>
...
onMounted(() => {
  ...
  console.log('CRUD Admin:', crudAdmin)
