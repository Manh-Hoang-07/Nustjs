...
import useCrudAdmin from '@/composables/data/useCrudAdmin'
...
async function fetchCategories() {
  try {
    const response = await api.get(endpoints.categories.list, { params: { all: true } })
...
async function fetchBrands() {
  try {
    const response = await api.get(endpoints.brands.list, { params: { all: true } })
