        ...
        <div class="flex justify-between items-center py-4">
          ...
          <nav class="flex items-center space-x-4">
            ...
            <ClientOnly>
              ...
              <template v-else>
                <NuxtLink to="/login" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  Đăng nhập
                </NuxtLink>
                <NuxtLink to="/register" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                  Đăng ký
                </NuxtLink>
              </template>
        ...
        <div class="border-t border-gray-200 py-3">
          <nav class="flex items-center justify-between">
            <div class="flex items-center space-x-8">
              ...
              <!-- Main Navigation -->
              <NuxtLink to="/" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Trang chủ</NuxtLink>
              <NuxtLink to="/products" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Sản phẩm</NuxtLink>
              <NuxtLink to="/about" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Giới thiệu</NuxtLink>
              ...
              <ClientOnly>
                <template v-if="isAuthenticated && userRole === 'admin'">
                  <NuxtLink to="/admin" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Admin Panel</NuxtLink>
                </template>
              </ClientOnly>
            </div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <NuxtLink to="/register" class="bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 px-8 py-4 rounded-lg text-lg font-semibold hover:from-yellow-300 hover:to-yellow-400 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Bắt đầu ngay
            </NuxtLink>
            <NuxtLink to="/about" class="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105">
              Tìm hiểu thêm
            </NuxtLink>
          </div>
    ...
    <section class="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <NuxtLink to="/register" class="bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
            Đăng ký miễn phí
          </NuxtLink>
          <NuxtLink to="/login" class="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105">
            Đăng nhập
          </NuxtLink>
        </div>
      </div>
