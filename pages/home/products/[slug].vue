  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
    ...
    <div v-else-if="product" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        <!-- Product Images -->
        <div>
          <div class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-xl bg-gradient-to-br from-blue-100 to-purple-100 shadow-lg">
            <img
              v-if="selectedImage"
              :src="selectedImage"
              :alt="product.name"
            ...
            >
            <div v-else class="h-full w-full bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
          ...
          <div v-if="product.images && product.images.length > 0" class="mt-4 grid grid-cols-4 gap-2">
            <div
              ...
              :key="index"
              class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 cursor-pointer transition-all duration-300 hover:scale-105"
        ...
        <div>
          ...
          <!-- Description -->
          <div v-if="product.description" class="mb-6 bg-white rounded-xl p-6 shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div class="relative aspect-w-1 aspect-h-1 w-full overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100">
              ...
              <!-- Featured Badge -->
              <div v-if="relatedProduct.featured" class="absolute top-3 right-3">
            ...
            <div class="p-4">
              <!-- Product Name -->
              <h3 class="text-lg font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">{{ relatedProduct.name }}</h3>
...
async function loadProduct() {
  loading.value = true
  try {
    const response = await apiClient.get(`/api/products/slug/${route.params.slug}`)
